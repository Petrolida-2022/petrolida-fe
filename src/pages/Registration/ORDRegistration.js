              ...
              <form onSubmit={e => handleSubmit(e)} noValidate>
                ...
                <div id="documentForm" className="form-container" style={{display: 'none'}}>
                  ...
                  <div className="my-3">
                    ...
                    <input required className="form-control" type="file" id="member2_file" name="member2_file" tabIndex="16" accept=".png,.jpg,.jpeg,.pdf" onChange={e => setData({...data, member3_file: e.target.files[0]})}/>
                  </div>
                  <div className="my-3">
                    <label htmlFor="member2_file" className="form-label">Team member 4</label>
                    <input required className="form-control" type="file" id="member2_file" name="member2_file" tabIndex="16" accept=".png,.jpg,.jpeg,.pdf" onChange={e => setData({...data, member4_file: e.target.files[0]})}/>
                  </div>
                  <h3 className="form-section h7 mt-4">Upload your Payment</h3>
                  <div className="my-3">
                    <label for="payment" className="form-label">Payment slip*</label>
                    <input required className="form-control" type="file" id="payment" name="payment" tabindex="17" accept=".png,.jpg,.jpeg,.pdf" onChange={e => setData({...data, payment: e.target.files[0]})}/>
                  </div>
